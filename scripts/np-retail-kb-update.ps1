...
function Get-ALObjects {
    ...
    $alFiles = Get-ChildItem $modulePath -Recurse -Filter "*.al" | Sort-Object Name
...
function Write-ApiMd {
    ...
    [void]$sb.AppendLine("> Source files: $(($objects.SourceFiles | ForEach-Object { Split-Path $_ -Leaf }) -join ', ')")
